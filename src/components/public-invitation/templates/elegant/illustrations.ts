...
export const ITINERARY_ILLUSTRATIONS: ItineraryIllustration[] = [
  { value: "church", label: "Church", src: `${ASSET_BASE}/itinerary-church.svg` },
  { value: "cake", label: "Cake", src: `${ASSET_BASE}/itinerary-cake.svg` },
  { value: "camera", label: "Camera", src: `${ASSET_BASE}/itinerary-camera.svg` },
  { value: "celebration", label: "Celebration", src: `${ASSET_BASE}/itinerary-celebration.svg` },
]

/** Cycled through for itinerary items that have no explicit illustration set. */
export const ITINERARY_ILLUSTRATION_FALLBACK = ITINERARY_ILLUSTRATIONS.map((i) => i.src)
