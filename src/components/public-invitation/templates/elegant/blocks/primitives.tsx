...
export function SealedPhoto({
  ...
  return (
    <div
      className={cn(
        "relative flex flex-col items-center w-full my-10",
        isTilted && "origin-center -rotate-12 scale-85",
        className,
      )}
    >
      <img
...
export function FullWidthPhoto({
  ...
  const imageClassName = cn(
    "object-cover w-full h-full aspect-[16/10]",
    className,
  );
...
export function ImagePlaceholder({ className }: { className?: string }) {
  return (
    <img
      src="/templates/image-placeholder.jpg"
