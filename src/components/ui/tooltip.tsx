...
/**
 * Self-provisioning tooltip root. Radix requires a `Tooltip.Provider` ancestor;
 * wrapping here means callers can drop a `<Tooltip>` anywhere without the app
 * shell having to mount a global provider. Nesting providers is a no-op.
 */
function Tooltip({
  ...props
